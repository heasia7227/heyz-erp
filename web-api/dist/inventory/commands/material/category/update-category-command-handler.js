...
exports.UpdateCategoryCommandHandler = void 0;
const typeorm_1 = require("typeorm");
const typeorm_2 = require("@nestjs/typeorm");
const cqrs_1 = require("@nestjs/cqrs");
const result_data_1 = require("../../../../utils/result-data");
const category_1 = require("../../../domains/material/category");
const update_category_command_1 = require("./update-category-command");
let UpdateCategoryCommandHandler = exports.UpdateCategoryCommandHandler = class UpdateCategoryCommandHandler {
...
exports.UpdateCategoryCommandHandler = UpdateCategoryCommandHandler = __decorate([
    (0, cqrs_1.CommandHandler)(update_category_command_1.UpdateCategoryCommand),
    __param(0, (0, typeorm_2.InjectRepository)(category_1.Category)),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], UpdateCategoryCommandHandler);
//# sourceMappingURL=update-category-command-handler.js.map