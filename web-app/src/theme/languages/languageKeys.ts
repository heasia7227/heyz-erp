...
export enum LANGUAGE_KEYS {
    ...
    //INVENTORY -> INVENTORY
    INVENTORY_MATERIAL_COUNT = "INVENTORY_MATERIAL_COUNT",

    //INVENTORY -> COUNTING -> TEMPORARY
    INVENTORY_COUNTING_TEMPORARY = "INVENTORY_COUNTING_TEMPORARY",
    INVENTORY_COUNTING_TEMPORARY_INITIATE = "INVENTORY_COUNTING_TEMPORARY_INITIATE",
    INVENTORY_COUNTING_DATE = "INVENTORY_COUNTING_DATE",
    INVENTORY_COUNTING_RESPONSIBLE_PERSON = "INVENTORY_COUNTING_RESPONSIBLE_PERSON",
    INVENTORY_COUNTING_SCENE_RESPONSIBLE_PERSON = "INVENTORY_COUNTING_SCENE_RESPONSIBLE_PERSON",
    INVENTORY_COUNTING_STATUS = "INVENTORY_COUNTING_STATUS",

    //INVENTORY -> COUNTING -> REGULAR
    INVENTORY_COUNTING_REGULAR = "INVENTORY_COUNTING_REGULAR",
    INVENTORY_COUNTING_REGULAR_RULE_SETUP = "INVENTORY_COUNTING_REGULAR_RULE_SETUP",

    //INVENTORY -> COUNTING -> DIFFERENCE
    INVENTORY_COUNTING_DIFFERENCE = "INVENTORY_COUNTING_DIFFERENCE",
